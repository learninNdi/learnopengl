...
const char *vertexLightingSource = "src/2.lighting/4.lighting_maps/4.2.lighting_maps_specular_map/colors.vs";
const char *fragmentLightingSource = "src/2.lighting/4.lighting_maps/4.2.lighting_maps_specular_map/colors.fs";

const char *vertexLightCubeSource = "src/2.lighting/4.lighting_maps/4.2.lighting_maps_specular_map/light_cube.vs";
const char *fragmentLightCubeSource = "src/2.lighting/4.lighting_maps/4.2.lighting_maps_specular_map/light_cube.fs";
