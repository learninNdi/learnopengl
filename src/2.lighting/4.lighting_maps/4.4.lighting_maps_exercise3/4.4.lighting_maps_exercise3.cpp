...
const char *vertexLightingSource = "src/2.lighting/4.lighting_maps/4.4.lighting_maps_exercise3/colors.vs";
const char *fragmentLightingSource = "src/2.lighting/4.lighting_maps/4.4.lighting_maps_exercise3/colors.fs";

const char *vertexLightCubeSource = "src/2.lighting/4.lighting_maps/4.4.lighting_maps_exercise3/light_cube.vs";
const char *fragmentLightCubeSource = "src/2.lighting/4.lighting_maps/4.4.lighting_maps_exercise3/light_cube.fs";
