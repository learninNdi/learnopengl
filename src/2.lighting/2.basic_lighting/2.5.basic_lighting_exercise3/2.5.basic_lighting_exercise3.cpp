...
const char *vertexLightingSource = "src/2.lighting/2.basic_lighting/2.5.basic_lighting_exercise3/colors.vs";
const char *fragmentLightingSource = "src/2.lighting/2.basic_lighting/2.5.basic_lighting_exercise3/colors.fs";

const char *vertexLightCubeSource = "src/2.lighting/2.basic_lighting/2.5.basic_lighting_exercise3/light_cube.vs";
const char *fragmentLightCubeSource = "src/2.lighting/2.basic_lighting/2.5.basic_lighting_exercise3/light_cube.fs";
