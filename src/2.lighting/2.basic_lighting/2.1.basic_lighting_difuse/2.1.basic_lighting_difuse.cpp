...
const char *vertexLightingSource = "src/2.lighting/2.basic_lighting/2.1.basic_lighting_difuse/colors.vs";
const char *fragmentLightingSource = "src/2.lighting/2.basic_lighting/2.1.basic_lighting_difuse/colors.fs";

const char *vertexLightCubeSource = "src/2.lighting/2.basic_lighting/2.1.basic_lighting_difuse/light_cube.vs";
const char *fragmentLightCubeSource = "src/2.lighting/2.basic_lighting/2.1.basic_lighting_difuse/light_cube.fs";
