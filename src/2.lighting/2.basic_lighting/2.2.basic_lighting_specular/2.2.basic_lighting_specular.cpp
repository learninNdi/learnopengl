...
const char *vertexLightingSource = "src/2.lighting/2.basic_lighting/2.2.basic_lighting_specular/colors.vs";
const char *fragmentLightingSource = "src/2.lighting/2.basic_lighting/2.2.basic_lighting_specular/colors.fs";

const char *vertexLightCubeSource = "src/2.lighting/2.basic_lighting/2.2.basic_lighting_specular/light_cube.vs";
const char *fragmentLightCubeSource = "src/2.lighting/2.basic_lighting/2.2.basic_lighting_specular/light_cube.fs";
