...
const char *vertexShaderSource = "src/1.getting_started/6.coordinates/6.1.coordinate_systems.vs";
const char *fragmentShaderSource = "src/1.getting_started/6.coordinates/6.1.coordinate_systems.fs";
