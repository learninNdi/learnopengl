...
const char *vertexShaderSource = "src/1.getting_started/4.textures/4.1.textures.vs";
const char *fragmentShaderSource = "src/1.getting_started/4.textures/4.6.textures_exercise4.fs";
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ourShader.setFloat("changeVisible", mixValue);
